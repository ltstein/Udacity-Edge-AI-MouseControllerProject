...
class GazeEstimator:
    ...
    def predict(self, left_eye, right_eye, head_angles):
        ...
        '''
        head_pose_angle, left_eye_input, right_eye_input = self.preprocess_input(
            left_eye, right_eye, head_angles)
        input_dict = {'head_pose_angles': head_pose_angle,
                      'left_eye_image': left_eye_input, 'right_eye_image': right_eye_input}
